...
public class FileUtils {
    public static Config loadConfigFromSelf(File file, String fileString) {
        if (! file.exists()) {
            try {
                StreamlineBase.INSTANCE.getDataFolder().mkdirs();
    ...
    public static File getPagesDirectory() {
        check(StreamlineBase.INSTANCE.getDataFolder());
        return new File(StreamlineBase.INSTANCE.getDataFolder(), "addons" + File.separator);
    }
